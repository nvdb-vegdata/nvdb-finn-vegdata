...
export default function VegnettPosisjonPopup({ results, loading, error, popupRef, onClose }: Props) {
  ...
  return (
    <div ref={popupRef} className="ol-popup">
      {hasContent && (
        <>
          <button type="button" className="popup-close-btn" aria-label="Lukk" onClick={onClose}>
